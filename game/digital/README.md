...
- **選角方式**：
  ...
  - **自選** — 全部 106 隻為池，Snake Draft 輪選，有搜尋 + 排序

### 對戰

- 左右對稱佈局，上方有即時淘汰賽樹
- 點「擲骰！」→ 骰子滾動 → 天賦觸發（骰到 6）→ 顯示分數 → 勝負
- 平手自動加賽
...
動畫重播邏輯在 `js/app.js` 的 `playBattleAnimation()`。
