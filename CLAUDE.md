...
**實體實測玩法（2026-07-15）**：兩位玩家各自為自己的動物擲骰，每場一戰定勝負，平手才重骰；以 4 強、8 強或 16 強單淘汰進行。目前不加 HP、能量或道具層。
...
**待完成**：
- [ ] 數位版實際遊玩測試
- [ ] 持續測試 4 強／8 強／16 強實體單淘汰的節奏與數值體驗
- [ ] 實體玩法穩定後，再決定最終卡片尺寸與製作方式
...
- **狀態**：玩法驗證中；最終尺寸與製作方式尚未定案，但不再阻擋實體遊玩測試
- **原有候選**：Tarot 尺寸（70×120mm）+ 卡套法
