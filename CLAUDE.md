...
└── sim/                      # 對戰模擬器
    ...
    └── results/              # 模擬結果（每規則 4 檔：report/h2h/matrix/tournament）
```
...
> **淘汰賽排除 3 隻相似動物**：加拉巴哥象龜、犛牛、水鹿
> 詳細數據見 `sim/results/original_rules_*.csv`
> 共用骰子規則見 `sim/results/shared_dice_*.csv`
