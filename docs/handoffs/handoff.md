...
> 狀態：首批 16 張已完成黑白試印；卡面改為 `117×170mm` 增加貼合容錯，另完成 4 隻動物的 V2／V2.1／V2.2 動作強度比較；等待新版尺寸試貼與孩子實玩

## 接手後先做什麼

不要直接擴充剩餘 116 張，也不要覆蓋現有 16 張正式圖片。依序進行：

1. 開啟動作比較 PDF，先比較非洲獅、皇帝企鵝、紅毛猩猩、金剛鸚鵡的 V2／V2.1／V2.2；目前只記錄成人偏好，不定案。
2. 用新版 `117×170mm` 正式 PDF 重印至少一頁，確認名義 `122×175mm` Poker 四邊約 `2.5mm` 的容錯是否足夠。
3. 等孩子有空跑完整淘汰賽，再以「能否只看圖說出動物與能力」決定動作強度。
...
3. 比較四隻動物的三種動作強度；注意候選圖也有主體占比變大的變因，不只姿勢不同。
